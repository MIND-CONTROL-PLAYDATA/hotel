...
public class HotelService {
    ...
    public HotelResponse update(Long hotelId, HotelRequest hotelRequest) {
        ...
        Hotel hotel = new Hotel(
                ...
                , hotelRequest.getEmail(), hotelRequest.getUrl(),byId.get().getRoom(), byId.get().getPromotions(), byId.get().getAvgRatings(), byId.get().getRegions(), byId.get().getAmenities(),byId.get().getHotelFacilities(), byId.get().getHotelFacilityUsages());
